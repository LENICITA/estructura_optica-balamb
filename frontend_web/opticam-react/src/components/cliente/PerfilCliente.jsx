...
const PerfilCliente = () => {
  ...
  const cargarPerfil = async () => {
    try {
      ...
      const nombreLocal = localStorage.getItem('nombre') || 'Cliente';
      setFormData({
        nombre: nombreLocal,
  ...
  return (
    <div className="container mx-auto py-10 px-5">
      <h2 className="text-2xl font-bold text-center mb-5">GESTIÓN DE PERFIL</h2>
        ...
        <form className="mt-4">
          ...
          <div className="mt-4">
            <button
              ...
              className="block w-full text-center bg-gray-600 text-white py-3 rounded-full no-underline hover:opacity-85 transition"
            >
              FÓRMULA
            </button>
          </div>
