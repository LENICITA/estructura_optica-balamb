// src/shared/validators/productoValidators.js
...
// VALIDADORES BÁSICOS
export const validarCategoria = (id) => {
...
export const checkCategoria = (id) => {
...
export const checkNombreProducto = (nombre) => {
...
export const checkDescripcionProducto = (descripcion) => {
...
export const checkMarcaProducto = (marca) => {
  if (!marca || !marca.trim()) {
...
export const checkPrecioProducto = (precio) => {
...
export const checkColorProducto = (color) => {
  if (!color || !color.trim()) {
...
export const checkIdProducto = (id) => {
  if (!validarId(id)) {
...
export const validarFormularioProducto = (data) => {
  const checks = [
...
export const validarFormularioEditarProducto = (data) => {
  const checks = [
    checkCategoria(data.id_categoria),
    checkNombreProducto(data.nombre),
    checkDescripcionProducto(data.descripcion),
