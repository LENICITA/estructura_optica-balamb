// src/features/admin/screens/DashboardRepartidores.tsx
  ...
  useEffect(() => {
    const cargarRepartidores = async () => {
      try {
        ...
        const repartidoresMapeados = data.map((r: any) => ({
  ...
  return (
    <TouchableWithoutFeedback onPress={() => {
      ...
      <SafeAreaView style={styles.container}>
        <Text style={styles.titulo}>Gestión de Repartidores</Text>
        ...
        <View style={styles.cardContainer}>
          <View style={[styles.cardInfo, styles.cardTotal]}>
            <View style={styles.iconWrapper}>
              <Ionicons name="people-outline" size={24} color="#B90F0F" />
            </View>
          ...
          <View style={[styles.cardInfo, styles.cardActivos]}>
            <View style={styles.checkCircle}>
              <Ionicons name="checkmark" size={16} color="white" />
            </View>
            <Text style={styles.cardNumero}>
              {repartidores.filter((r) => r.estado === "ACTIVO").length}
            </Text>
            <Text style={styles.cardLabel}>
              Activos
            </Text>
          ...
          <View style={[styles.cardInfo, styles.cardInactivos]}>
            <View style={styles.circleIcon}>
              <View style={styles.verticalLine}></View>
              <View style={styles.verticalLine}></View>
            </View>
            <Text style={styles.cardNumero}>
              {repartidores.filter((r) => r.estado === "INACTIVO").length}
            </Text>
            <Text style={styles.cardLabel}>
              Inactivos
            </Text>
        ...
        <View style={styles.filtroContainer}>
          <TouchableOpacity
            style={[styles.cardFiltro, filtro === "todos" && styles.botonSeleccionado]}
            onPress={() => setFiltro("todos")}>
            <Text style={[styles.textoFiltro, filtro === "todos" && styles.textoSeleccionado]}>
              Todos ({repartidores.length})
            </Text>
          </TouchableOpacity>

          <TouchableOpacity
            style={[styles.cardFiltro, filtro === "ACTIVO" && styles.botonSeleccionado]}
            onPress={() => setFiltro("ACTIVO")}>
            <Text style={[styles.textoFiltro, filtro === "ACTIVO" && styles.textoSeleccionado]}>
              Activos ({repartidores.filter((r) => r.estado === "ACTIVO").length})
            </Text>
          </TouchableOpacity>

          <TouchableOpacity
            style={[styles.cardFiltro, filtro === "INACTIVO" && styles.botonSeleccionado]}
            onPress={() => setFiltro("INACTIVO")}>
            <Text style={[styles.textoFiltro, filtro === "INACTIVO" && styles.textoSeleccionado]}>
                  ...
                  <View style={styles.infoPrincipal}>
                    <View style={styles.nombreRow}>
                      ...
                      <View style={[
                        ...
                        <View style={[
                          styles.estadoDot,
                          item.estado === "ACTIVO" ? styles.dotVerde : styles.dotRojo
                        ]} />
                        <Text style={[
                          styles.estadoTexto,
                          item.estado === "ACTIVO" ? styles.estadoTextoActivo : styles.estadoTextoInactivo
                        ]}>
                          {item.estado}
                        </Text>
                      </View>
                ...
                <View style={styles.resumen}>
                  <View style={styles.resumenItem}>
                    ...
                    <Text style={styles.resumenText}>
                      {item.pedidos || 0} pedidos asignados
                    </Text>
                  </View>
        ...
        <View style={styles.containerFlotante}>
          ...
          <Text style={styles.textoFlotante}>Agregar Repartidor</Text>
        </View>
      </SafeAreaView>
    </TouchableWithoutFeedback>
  );
