...
export const Home = () => { //
  ...
  return (
    ...
    >
      {/* ===== BANNER HERO ===== */}
      <ImageBackground
        source={require("../../../../assets/img/imagen-bg.jpeg")} // ← con img/
      ...
      <View style={styles.cardsContainer}>
        ...
        >
          <ImageBackground
            source={require("../../../../assets/img/card.jpg")} // ← con img/
        ...
        >
          <ImageBackground
            source={require("../../../../assets/img/card2.jpg")} // ← con img/
            style={styles.smallCard}
            imageStyle={styles.cardImage}
          >
            <View style={styles.overlay}>
        ...
        >
          <ImageBackground
            source={require("../../../../assets/img/card3.jpg")} // ← con img/
