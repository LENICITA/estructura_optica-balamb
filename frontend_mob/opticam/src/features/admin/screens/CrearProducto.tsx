    ...
    >
      ...
      <View style={styles.card}>
        <View style={styles.headerCard}>
          <Ionicons name="add-circle-outline" size={24} color={COLORS.primary} style={styles.iconCard} />
          <Text style={styles.titleCard}>Crear Nuevo Producto</Text>
        </View>
        <View style={styles.contentCard}>
          <Text style={styles.subtitle}>Formulario para crear un nuevo producto.</Text>
          ...
          <View style={styles.uploadButtonContainer}>
            {subiendo ? (
              <View style={styles.loadingButton}>
                ...
                <Text style={styles.loadingButtonText}>Creando producto...</Text>
              </View>
            ) : (
              <TouchableOpacity
              ...
              >
                ...
                <Text style={styles.crearButtonText}>Crear Producto</Text>
              </TouchableOpacity>
            )}
          </View>
        </View>
