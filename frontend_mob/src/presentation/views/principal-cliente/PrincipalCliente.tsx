...
const PrincipalCliente = () => {
  ...
  const cargarDatosCliente = async () => {
    try {
      ...
      // Intentar traer productos desde el backend
      try {
  ...
  const actualizarContadorCarrito = async () => {
    try {
      // Si tienes API para carrito, conéctala aquí
      setTotalItems(0);
    } catch (error) {
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
          ...
          <View style={styles.categoriasGrid}>
            {[
              ...
              <TouchableOpacity 
                ...
                onPress={() => navigation.navigate(cat.action as never)}
              >
        ...
        <View style={styles.section}>
          <View style={styles.sectionHeader}>
            ...
            <TouchableOpacity onPress={() => navigation.navigate('Catalogo' as never)}>
