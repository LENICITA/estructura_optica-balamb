...
function FormularioEditarRepartidor({
  navigation,
  route,
}: {
  navigation: any;
  ...
  useEffect(() => {
    ...
    const cargarRepartidor = async () => {
      ...
      try {
        ...
        // Si existe una fecha guardada,
        // la convertimos en Date para el calendario
  ...
  const handleFechaChange = (
    ...
    // Android cierra el calendario automáticamente
    ...
    // En iOS mantenemos abierto hasta que
    // el usuario termine
    if (Platform.OS === 'ios') {
      setMostrarCalendario(true);
    }
