...
export default function detalleRepartidor() {
    const route = useRoute<any>();
    const navigation = useNavigation<any>();
    const { id, nombre, estado, telefono, correo, ciudad, pedidos, fecha_registro } = route.params;
    ...
    useEffect(() => {
        const cargarDatosRepartidor = async () => {
            try {
                ...
                const response = await api.get(`/usuarios/repartidores/${id}`);
        ...
        <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
            ...
            <View style={styles.sectionCard}>
                ...
                <View style={styles.infoItem}>
                    ...
                    <Text style={styles.infoValue}>{formatDate(fecha_registro)}</Text>
                </View>
            </View>
                ...
                {LoadingVehiculo ? (
                    ...
                    <>
                        ...
                        <View style={styles.infoItem}>
                            ...
                            <Text style={styles.infoValue}>{vehiculo.marca || "No especificada"}</Text>
                        </View>
                        ...
                        <View style={styles.infoItem}>
                            ...
                            <Text style={styles.infoValue}>{vehiculo.anio || "No especificado"}</Text>
                        </View>
                    </>
                ) : (
