// src/presentation/views/login/Login.tsx
  ...
  const handleRedirectByRole = () => {
    try {
      ...
      if (Array.isArray(user.roles)) {
        ...
        console.log('⚠️ Usuario sin roles, redirigiendo a Home');
        navigation.navigate('Home');
        return;
      }
      ...
      if (firstRole === 'ADMIN' || firstRole === 'ADMINISTRADOR') {
        ...
        navigation.navigate('RepartidorInicio');
      } else if (firstRole === 'CLIENTE') {
        console.log('✅ Redirigiendo a PrincipalCliente');
