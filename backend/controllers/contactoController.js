...
export const enviarMensaje = async (req, res) => {
  try {
    ...
    // 2️⃣ Guardar en base de datos (si tienes modelo)
    // Si tienes un modelo MensajeContacto:
    ...
    // 3️⃣ ENVIAR CORREO ELECTRÓNICO
    try {
      // Correo para la óptica
      const mailOptions = {
      ...
      // 4️⃣ (Opcional) Enviar correo de confirmación al cliente
      // const clienteMailOptions = {
      //   from: `"Óptica Balamb" <${process.env.SMTP_USER}>`,
      //   to: email,
      ...
      //       <p>Saludos,<br><strong>Óptica Balamb</strong></p>
      //     </div>
      //   `,
      // };
