...
document.addEventListener("DOMContentLoaded", () => {
    ...
    function actualizarHeaderAutenticacion() {
        ...
        if (usuario && rol) {
            if (rol === 'admin') {
                ...
                iconsDiv.innerHTML = `
                    <button id="btn-mensajes"><i class="fa-regular fa-envelope"></i></button>
                    <button onclick="window.location.href='../repartidor/perfilrepa.html'" class="user-icon">
                        <i class="fa-solid fa-circle-user"></i>
                    </button>
                `;
            } else if (rol === 'cliente') {
                iconsDiv.innerHTML = `
                    <button onclick="window.location.href='../cliente/carrito.html'">
            ...
            iconsDiv.innerHTML = `
                <div class="auth-buttons">
                    <a href="iniciosesion.html" class="login-btn">Iniciar sesión</a>
    ...
    function cargarMenu() {
        ...
        if (rol === "admin") {
            menu.innerHTML = `
                <a href="../admin/principaladmin.html">Inicio</a>
                <a href="../admin/perfiladmin.html">Mi perfil</a>
                <a href="../admin/inventario.html">Inventario</a>
