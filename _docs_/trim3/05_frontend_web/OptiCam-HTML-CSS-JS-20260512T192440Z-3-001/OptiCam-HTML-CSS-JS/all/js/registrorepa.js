...
console.log("REPARTIDORES GUARDADOS:", JSON.parse(localStorage.getItem("repartidores")));
alert("✅ ¡Repartidor registrado exitosamente!\n\nTotal repartidores: " + JSON.parse(localStorage.getItem("repartidores")).length);
        
        alert("✅ ¡Repartidor registrado exitosamente!");
        window.location.href = "../admin/controlrepartidores.html";
    });
});